...
func (a AwayBoxscore) parseQuarterScore(quarterNumber uint) uint {
	...
	if len(a.GameExtract.ESPN.Header.Competitions[0].Competitors[0].Linescores) == 0 || len(a.GameExtract.ESPN.Header.Competitions[0].Competitors[1].Linescores) == 0 {
		return 0
	} else {
		var team1HomeAway string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[0].HomeAway
		var team2HomeAway string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[1].HomeAway
		var team1Points string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[0].Linescores[linescoreArraryIndex].DisplayValue
		var team2Points string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[1].Linescores[linescoreArraryIndex].DisplayValue
...
func (a AwayBoxscore) parseTotalScore() uint {
	var team1HomeAway string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[0].HomeAway
	var team2HomeAway string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[1].HomeAway
	var team1Points string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[0].Score
	var team2Points string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[1].Score
...
func (a AwayBoxscore) ParseOvertimeScore() uint {
	var team1HomeAway string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[0].HomeAway
	var team2HomeAway string = a.GameExtract.ESPN.Header.Competitions[0].Competitors[1].HomeAway
	var team1PointsSlice []espngame.LinescoreProperty = a.GameExtract.ESPN.Header.Competitions[0].Competitors[0].Linescores
	var team2PointsSlice []espngame.LinescoreProperty = a.GameExtract.ESPN.Header.Competitions[0].Competitors[1].Linescores
