...
const FOX_CFB_SCHEDULE_URL string = "https://www.foxsports.com/college-football/schedule"
const FOX_SEASON_TYPE string = "reg"

const ESPN_CFB_SCHEDULE_ENDPOINT_URL string = "https://site.api.espn.com/apis/site/v2/sports/football/college-football/scoreboard"
